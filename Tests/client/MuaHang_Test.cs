...
namespace MuaHang_Test
{
    ...
    public class PurchaseTests
    {
        ...
        public void ID_MuaHang_1()
        {
            ...
            ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_1", result ? "Pass" : "Fail", log.ToString());
        }
        ...
        public void ID_MuaHang_2()
        {
            ...
            if (currentUrl == "https://frontend-salephones.vercel.app/orderSuccess")
            {
                ...
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_2", "Fail", "Mua hàng và chuyển hướng đến trang orderSuccess thành công. Không thông báo giá mới cho người dùng.");
            }
            else
            {
                Console.WriteLine("Chuyển hướng đến trang orderSuccess không thành công. URL hiện tại: " + currentUrl);
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_2", "Pass", "Không thể mua hàng do sản phẩm đã bị xóa");
            }
        ...
        public void ID_MuaHang_3()
        {
            ...
            {
                Console.WriteLine("Chuyển hướng đến trang orderSuccess thành công.");
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_3", "Fail", "Mua hàng và chuyển hướng đến trang orderSuccess thành công. Không thông báo giá mới cho người dùng.");
            }
            else
            {
                Console.WriteLine("Chuyển hướng đến trang orderSuccess không thành công. URL hiện tại: " + currentUrl);
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_3", "Pass", "Mua hàng thất bại");
            }
        }
        ...
        public void ID_MuaHang_4()
        {
            ...
            {
                Console.WriteLine("Chuyển hướng đến trang orderSuccess thành công.");
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_4", "Fail", "Mua hàng và chuyển hướng đến trang orderSuccess thành công. /n Không kiểm tra số lượng sản phẩm tồn kho.");
            }
            else
            {
                Console.WriteLine("Chuyển hướng đến trang orderSuccess không thành công. URL hiện tại: " + currentUrl);
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_4", "Pass", "Mua hàng thất bại do không đủ sản phẩm");
            }
        }
        ...
        public void ID_MuaHang_5()
        {
            ...
            if (isProductInCart)
            {
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_5", "Pass", "Mua hàng không thành công");
            }
            else
            {
                ExcelReportHelper_Tran.WriteToExcel("Testcase Trân", "ID_MuaHang_5", "Fail", "Mua hàng thành công");
            }
        }
